...
summary: "Built discrete choice models (MNL, Random Forest, XGBoost) in R, combined via a soft-voting ensemble, to predict consumer trade-offs among vehicle safety-feature bundles — placing 1st runner-up in a GM-sponsored data competition."
---
...
<ProjectImage
  src="/projects/transportation-analytics/xgboost-importance_01.png"
...
<ProjectImage
  src="/projects/transportation-analytics/rf-importance_01.png"
...
<ImageGrid
  columns={2}
  images={[
    { src: "/projects/transportation-analytics/shap-choice1_01.png", alt: "SHAP importance plot for customers who chose package 1, dominated by Price1" },
    { src: "/projects/transportation-analytics/shap-choice2_01.png", alt: "SHAP importance plot for customers who chose package 2, dominated by Price2" },
  ]}
/>
