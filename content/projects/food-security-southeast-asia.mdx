...
dateStart: "2023-09"
dateEnd: "2023-12"
coverImage: "/projects/food-security-southeast-asia/cover.jpg"
...
<ProjectImage
  src="/projects/food-security-southeast-asia/gradient-descent-illustration_01.png"
...
<ImageGrid
  images={[
    { src: "/projects/food-security-southeast-asia/yield-rice-by-country_01.png", alt: "Scatter plot of rice yield over time across Southeast Asian countries" },
    { src: "/projects/food-security-southeast-asia/yield-top-crops-vietnam_01.png", alt: "Scatter plot of yield for the top 5 crop items in Vietnam over time" },
  ]}
/>

<ProjectImage
  src="/projects/food-security-southeast-asia/agriculture-gdp-share_01.png"
...
<ProjectImage
  src="/projects/food-security-southeast-asia/cost-function-crops_01.png"
...
<ProjectImage
  src="/projects/food-security-southeast-asia/model-eval-metrics-validation_01.png"
  alt="Bar chart of R-squared, adjusted R-squared, and MSE per crop on the validation dataset"
  caption=""
/>

<ProjectImage
  src="/projects/food-security-southeast-asia/model-eval-ttest-validation_01.png"
  alt="Bar chart of t-test results per feature and crop on the validation dataset"
  caption=""
/>

<ProjectImage
  src="/projects/food-security-southeast-asia/model-eval-ftest-validation_01.png"
  alt="Bar chart of F-test results per crop on the validation dataset"
  caption=""
/>

<ProjectImage
  src="/projects/food-security-southeast-asia/feature-significance-model1_01.png"
...
<ProjectImage
  src="/projects/food-security-southeast-asia/model-eval-metrics-test_01.png"
  alt="Bar chart of R-squared, adjusted R-squared, and MSE per crop on the test dataset"
  caption=""
/>

<ProjectImage
  src="/projects/food-security-southeast-asia/model-eval-ttest-test_01.png"
  alt="Bar chart of t-test results per feature and crop on the test dataset"
  caption=""
/>

<ProjectImage
  src="/projects/food-security-southeast-asia/model-eval-ftest-test_01.png"
  alt="Bar chart of F-test results per crop on the test dataset"
  caption=""
/>

<ProjectImage
  src="/projects/food-security-southeast-asia/feature-significance-model2_01.png"
...
<ImageGrid
  images={[
    { src: "/projects/food-security-southeast-asia/colormap-model1-evaluation_01.png", alt: "Color-coded table of R-squared, adjusted R-squared, and MSE for model 1" },
    { src: "/projects/food-security-southeast-asia/colormap-model2-test_01.png", alt: "Color-coded table of R-squared, adjusted R-squared, and MSE for model 2 test results" },
  ]}
/>

<ProjectImage
  src="/projects/food-security-southeast-asia/model-comparison-change-table_01.png"
